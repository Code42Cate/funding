...
export const Pagination = ({ page, pageSize, total }: { page: number; pageSize: number; total: number }) => {
  ...
  return (
    <div className="mt-8 flex items-center justify-between p-5">
        ...
        <div>
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {Array.from({ length: 3 }).map((_, i) => (
              <button
                ...
                className={classNames('relative inline-flex items-center px-4 py-2 text-sm font-semibold focus:z-20', {
                  'z-10 bg-purple-100 text-purple-600 ring-1 ring-inset ring-purple-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600':
                    page === i + 1,
            ...
            <button
              aria-current="page"
              className={classNames(
                'relative inline-flex cursor-default items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-20'
              )}
            >
              ...
            </button>
